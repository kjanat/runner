...
// Committed roff man pages (generated by `just gen-man`). The facade ships
// these via its package.json `man` field so `npm i -g` wires up
// `man runner` / `man run`. Single source of truth — no per-build rendering.
const manSrcDir = join(repoDir, "man");
